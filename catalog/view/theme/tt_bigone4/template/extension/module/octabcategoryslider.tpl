...
<?php
	...
	if(!$row) {$row=1;}
?>
<div class="product-tabs-category-container-slider special-button-owl <?php echo $cateogry_alias;?> quickview-add module-nav2 box-module module-style1">
		...
		<?php foreach($category_products as $cate_id => $products ){ ?>
			<div id="tab_cate<?php echo $cate_id; ?>" class="tab_content_category">
				...
				<?php foreach ($products as $product){ ?>
					<?php if($count++ % $row ==0){  echo  "<li class='row_items'><div class='product-thumb'>"; } ?>
				 	<div class="item">
...
$(document).ready(function() { 
  $(".<?php echo $cateogry_alias;?> .owl-demo-tabcate").owlCarousel({
	...
	afterAction: function(){
		$(".<?php echo $cateogry_alias;?> .owl-demo-tabcate .owl-wrapper .owl-item").removeClass('first');
		$(".<?php echo $cateogry_alias;?> .owl-demo-tabcate .owl-wrapper .owl-item").removeClass('last');
		$(".<?php echo $cateogry_alias;?> .owl-demo-tabcate .owl-wrapper .owl-item").removeClass('before-active');
		$(".<?php echo $cateogry_alias;?> .owl-demo-tabcate .owl-wrapper .owl-item.active:first").addClass('first');
		$(".<?php echo $cateogry_alias;?> .owl-demo-tabcate .owl-wrapper .owl-item.active:last").addClass('last');
		$('.<?php echo $cateogry_alias;?> .owl-demo-tabcate .owl-wrapper .owl-item.active:first').prev().addClass('before-active');
	}
  });
});
</script>