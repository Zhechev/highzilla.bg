<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="econt_form" class="form-horizontal">
  <div class="content">
    <div>
      <div class="form-group" id="aps_info" <?php if ($shipping_to != 'APS' || !$to_aps) { ?>style="display: none;"<?php } ?>>
        <div class="col-sm-12"><p class="alert alert-warning"><i><?php echo $text_aps_info; ?></i></p></div>
      </div>
      <?php if ($error_cd_payment_aps) { ?>
        <div class="form-group" id="aps_info" <?php if ($shipping_to != 'APS' || !$to_aps) { ?>style="display: none;"<?php } ?>>
          <div class="col-sm-12"><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_cd_payment_aps; ?></div></div>
        </div>
      <?php } ?>
      ...
      <div class="form-group" style="display: none;">
        ...
        <div class="col-sm-10">
          <input type="radio" id="to_door" name="shipping_to" value="DOOR" <?php if ($shipping_to == 'DOOR') { ?> checked="checked"<?php } ?> onclick="$('#econt_office_city_id,#econt_office_city_aps_id,#econt_office_id,#econt_office_aps_id,#econt_office_code,#econt_office_aps_code,#econt_office_locator,#aps_info,#content_services_aps').hide(); $('#econt_post_code,#econt_city,#econt_quarter,#econt_street,#econt_street_num,#econt_other,#services_door,#content_services').show();" />
          <label for="to_door"><?php echo $text_to_door; ?></label>
          <input type="radio" id="to_office" name="shipping_to" value="OFFICE" <?php if ($shipping_to == 'OFFICE') { ?> checked="checked"<?php } ?> onclick="$('#econt_office_city_id,#econt_office_id,#econt_office_code,#econt_office_locator,#content_services').show();$('#econt_post_code,#econt_city,#econt_quarter,#econt_street,#econt_street_num,#econt_other,#services_door,#econt_office_city_aps_id,#econt_office_aps_id,#econt_office_aps_code,#aps_info,#content_services_aps').hide();" />
          <label for="to_office"><?php echo $text_to_office; ?></label>
          <input type="radio" id="to_aps" name="shipping_to" value="APS" <?php if ($shipping_to == 'APS') { ?> checked="checked"<?php } ?> onclick="$('#econt_office_city_aps_id,#econt_office_aps_code,#econt_office_aps_id,#aps_info,#content_services_aps').show();$('#econt_post_code,#econt_city,#econt_quarter,#econt_street,#econt_street_num,#econt_other,#services_door,#econt_office_locator,#econt_office_city_id,#econt_office_id,#econt_office_code,#content_services').hide();" />
          <label for="to_aps"><?php echo $text_to_aps; ?></label>
        </div>
      </div>
      <div class="form-group" id="econt_post_code" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
      ...
      <div class="form-group" id="econt_city" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
      ...
      <div class="form-group" id="econt_quarter" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
      ...
      <div class="form-group" id="econt_street" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
      ...
      <div class="form-group" id="econt_street_num" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
      ...
      <div class="form-group" id="econt_other" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
      ...
      <div class="form-group" id="econt_office_city_id" <?php if ($shipping_to != 'OFFICE' || $shipping_to == 'APS' || !$to_office) { ?> style="display: none;"<?php } ?>>
        ...
        <div class="col-sm-10">
          <select id="office_city_id" name="office_city_id" onchange="getOfficesByCityId(0);" class="form-control">
            ...
            <?php foreach ($cities as $city_office) { ?>
            <?php if ($city_office['city_id'] == $office_city_id) { ?>
            <option value="<?php echo $city_office['city_id']; ?>" selected="selected"><?php echo $city_office['name']; ?></option>
            <?php } else { ?>
            <option value="<?php echo $city_office['city_id']; ?>"><?php echo $city_office['name']; ?></option>
            <?php } ?>
            <?php } ?>
          </select>
        </div>
      </div>
      <div class="form-group" id="econt_office_city_aps_id" <?php if ($shipping_to == 'OFFICE' || $shipping_to != 'APS' || !$to_aps) { ?> style="display: none;"<?php } ?>>
        <label class="col-sm-2 control-label" for="office_city_aps_id"><?php echo $entry_city; ?></label>
        <div class="col-sm-10">
          <select id="office_city_aps_id" name="office_city_aps_id" onchange="getOfficesByCityId(1);" class="form-control">
            <option value="0"><?php echo $text_select; ?></option>
            <?php foreach ($cities_aps as $city) { ?>
            <?php if ($city['city_id'] == $office_city_aps_id) { ?>
      ...
      <div class="form-group" id="econt_office_aps_id" <?php if ($shipping_to != 'APS' || !$to_aps) { ?> style="display: none;"<?php } ?>>
        <label class="col-sm-2 control-label" for="office_aps_id"><?php echo $entry_office; ?></label>
        <div class="col-sm-10">
          <select id="office_aps_id" name="office_aps_id" onchange="getOffice(1);" class="form-control">
            <option value="0"><?php echo $text_select; ?></option>
            <?php foreach ($offices_aps as $office) { ?>
            <?php if ($office['office_id'] == $office_aps_id) { ?>
            <option value="<?php echo $office['office_id']; ?>" selected="selected"><?php echo $office['office_code'] . ', ' . $office['name'] . ', ' . $office['address']; ?></option>
            <?php } else { ?>
            <option value="<?php echo $office['office_id']; ?>"><?php echo $office['office_code'] . ', ' . $office['name'] . ', ' . $office['address']; ?></option>
            <?php } ?>
          ...
          <?php if ($error_office_aps) { ?>
          <span class="text-danger"><?php echo $error_office_aps; ?></span>
          <?php } ?>
        </div>
      </div>
      ...
      <div class="form-group" id="econt_office_aps_code" <?php if ($shipping_to != 'APS' || !$to_aps) { ?> style="display: none;"<?php } ?>>
        <label class="col-sm-2 control-label" for="office_aps_code"><?php echo $entry_office_code; ?></label>
        <div class="col-sm-10">
          <input type="text" id="office_aps_code" name="office_aps_code" value="<?php echo $office_aps_code; ?>" size="3" disabled="disabled" class="form-control" />
        </div>
      </div>
    ...
    <div id="services_door" <?php if ($shipping_to == 'OFFICE' || $shipping_to == 'APS' || !$to_door) { ?> style="display: none;"<?php } ?>>
  ...
  <div class="content" id="content_services" <?php if ($shipping_to == 'APS' || $to_aps) { ?> style="display: none;"<?php } ?>>
    <?php if ($dc) { ?>
  ...
  <div class="content" id="content_services_aps" <?php if ($shipping_to != 'APS' || !$to_aps) { ?> style="display: none;"<?php } ?>>
    <p><i><?php echo $text_services_aps; ?></i></p>
  </div>
</form>
...
$(document).ready(function() {
	...
	var econt_city = '<?php echo $city['name']; ?>';
