					...
					<div class="item-inner">
						...
						<div class="des-container">
							...
							<?php if($config_slide['f_show_des']){ ?>
							  <p class="description"><?php echo substr($product['description'],0,250).'...'; ?></p>
							<?php } ?>
		...
		<div class="list-thumb">
			<ul class="thumb">
				<?php $j=0; foreach ($products as $product) : ?>
					<li class="thumbinner<?php echo $j; echo ($j==0) ? ' active' : ''?>" onclick="timerslider(<?php echo $j; $j++;?>)" >
	...
	<?php if($use_thumbnail_slider): ?>
		$('.occountdown_module .list-thumb .thumb').owlCarousel({
			...
			afterAction: function(){
				$(".occountdown_module .list-thumb .thumb  .owl-wrapper .owl-item").removeClass('first');
				$(".occountdown_module .list-thumb .thumb  .owl-wrapper .owl-item.active:first").addClass('first');
			}
		});
	<?php endif; ?>
