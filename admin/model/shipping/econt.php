...
class ModelShippingEcont extends Model {
	...
	public function updateTablesAPS() {
		$this->db->query("ALTER TABLE `" . DB_PREFIX . "econt_office` ADD `is_machine` tinyint(1) NOT NULL DEFAULT '0'");
		$this->db->query("ALTER TABLE `" . DB_PREFIX . "econt_customer` ADD `office_aps_id` int(11) NOT NULL DEFAULT '0'");
	}
